...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: {
      ru: 'Дочка с радостью бежит на занятия! Очень нравится игровой формат обучения. За 2 месяца заметный прогресс.',
      en: 'My daughter runs to class with joy! She loves the game-based learning format. Noticeable progress in 2 months.',
    },
    childAge: '7',
  },
  {
